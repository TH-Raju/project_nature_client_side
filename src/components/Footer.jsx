...
const Footer = () => {
    return (
        <div>
            <footer className="bottom-0 p-6 dark:bg-gray-800 dark:text-gray-100">
                ...
                <div className="flex items-center justify-center px-6 pt-12 text-sm">
                    <span className="dark:text-gray-400">© Copyright 2023. All Rights Reserved. Designed By <a href="https://www.facebook.com/rjraju.r8/" target="__blank" className='text-blue-700 underline'>TH Raju</a></span>
                </div>
            </footer>
        </div>
    );
